...
/// @file Greedy_BaseGen.cc
/// @brief Greedy_BaseGen の実装ファイル
...
void
Greedy_BaseGen::generate(const vector<const RegVect*>& rv_list,
		    ymuint req_num,
...
Variable
Greedy_BaseGen::choose_var(vector<Variable>& var_list)
{
